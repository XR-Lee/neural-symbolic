...
def IMG(jsonname,jsonname_new):####.....json
    ...
    file = '/DATA_EDS2/wanggl/datasets/BEV722'
    rootimg = file + '/' + root + '/' 
...
def main():
    ...
    '''
    a000 = '/DATA_EDS2/zhangzz2401/zhangzz2401/OpenLane-V2-master/data/OpenLane-V2/val/10003/info/315976483749927216-ls.json'
    a001 = '/DATA_EDS2/wanggl/datasets/pkl2json517val/10003/info/315976483749927216-ls.json'
